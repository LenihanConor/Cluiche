...
TEST(ActionMap, MultipleBindingsForSameAction)
{
	...
	spaceEvent.key = static_cast<int>(EKey::Space);
...
TEST(ActionMap, MultipleActionsSimultaneously)
{
	...
	wEvent.key = static_cast<int>(EKey::W);
	events.Add(wEvent);
...
TEST(ActionMap, DigitalInputsReturnOneOrZero)
{
	...
	pressEvent.key = static_cast<int>(EKey::Space);
	...
	releaseEvent.key = static_cast<int>(EKey::Space);
...
TEST(ActionMap, RemoveCallback)
{
	...
	evt2.key = static_cast<int>(EKey::Space);
	events2.Add(evt2);
