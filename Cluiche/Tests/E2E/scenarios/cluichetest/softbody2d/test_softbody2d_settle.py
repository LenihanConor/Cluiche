...
def test_softbody2d_rope_settles(dia_client):
    ...
    try:
        result = dia_client.poll_checkpoint(_ROPE_CHECKPOINT, timeout_s=70.0)
...
def test_softbody2d_cloth_settles(dia_client):
    ...
    dia_client.navigate_to("SoftBody2DTestStage")
    try:
        result = dia_client.poll_checkpoint(_CLOTH_CHECKPOINT, timeout_s=70.0)
...
def test_softbody2d_rope_settles_before_cloth(dia_client, assert_metric):
    ...
    dia_client.navigate_to("SoftBody2DTestStage")
    try:
        rope_result  = dia_client.poll_checkpoint(_ROPE_CHECKPOINT,  timeout_s=70.0)
        cloth_result = dia_client.poll_checkpoint(_CLOTH_CHECKPOINT, timeout_s=70.0)
...
def test_softbody2d_determinism(dia_client):
    ...
    dia_client.navigate_to("SoftBody2DTestStage")
    try:
        r1_rope  = dia_client.poll_checkpoint(_ROPE_CHECKPOINT,  timeout_s=70.0)
        r1_cloth = dia_client.poll_checkpoint(_CLOTH_CHECKPOINT, timeout_s=70.0)
    ...
    dia_client.navigate_to("SoftBody2DTestStage")
    try:
        r2_rope  = dia_client.poll_checkpoint(_ROPE_CHECKPOINT,  timeout_s=70.0)
        r2_cloth = dia_client.poll_checkpoint(_CLOTH_CHECKPOINT, timeout_s=70.0)
