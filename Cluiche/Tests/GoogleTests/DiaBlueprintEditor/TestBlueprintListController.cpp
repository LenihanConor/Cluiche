...
{
	const char* ids[]   = { "diaentity.player" };
	const char* paths[] = { "Assets/player.diaentity" };
...
{
	const char* eIds[]  = { "diaentity.enemy" };
	const char* ePaths[] = { "Assets/enemy.diaentity" };
...
{
	const char* ids[]   = { "diaentity.a", "diaentity.b", "diaentity.c" };
	const char* paths[] = { "a.diaentity", "b.diaentity", "c.diaentity" };
