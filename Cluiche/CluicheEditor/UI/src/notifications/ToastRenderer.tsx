...
import { Toast, useNotificationStore } from "./useNotifications";

// ---------------------------------------------------------------------------
// Animation injection — runs once per page load
// ---------------------------------------------------------------------------
...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  // Schedule auto-dismiss (skip when durationSeconds === 0)
  const scheduleTimer = () => {
    if (toast.durationSeconds === 0) return;
    timerRef.current = setTimeout(startExit, toast.durationSeconds * 1000);
  };
...
// ---------------------------------------------------------------------------
// ToastRenderer — shell-level container
// ---------------------------------------------------------------------------
