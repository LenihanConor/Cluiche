...
const scriptPath = join(__dirname, "../../../../../Dia/DiaEditor/Plugin/Assets/debug-layers/debug-layers.js");
const scriptContent = readFileSync(scriptPath, "utf-8");
function dispatchLayerState(state) {
...
// ---------------------------------------------------------------------------
function badge() {
    return document.getElementById("drop-badge");
}
function list() {
    return document.getElementById("layer-list");
}
function emptyMsg() {
    return document.getElementById("empty-msg");
}
// ============================================================================
...
describe("applyLayerState — sort order", () => {
    it("applyLayerState_SortsByPriority", () => {
        ...
        const spans = list().querySelectorAll("span.layer-name");
