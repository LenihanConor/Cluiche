...
from dia_cli.utils.dia_cli_template import CodeGenTemplate
...
def create_command(dia_cli_paths: DiaCLIPaths, command_name: str, module_path: Path):
    ...
    """
    template_path = dia_cli_paths.cli().joinpath(TEMPLATE_FOLDER).resolve()
