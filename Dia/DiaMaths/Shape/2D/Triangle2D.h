...
namespace Dia
{
	namespace Maths
	{
		...
		public:
			...
			Triangle2D(const Triangle2D& rhs);
			...
			Vector2D	CenterOfGravity()const;
			
			void		CalculateInCircle(Circle2D& circle)const;
			void		CalculateCircumCircle(Circle2D& circle)const;
...
#include "DiaMaths/Shape/2D/Triangle2D.inl"