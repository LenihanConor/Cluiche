(function() {
    ...
    if (window.diaBridge) {
        window.diaBridge.onDataChanged('asset_runtime_inspector.inspector_data', function(data) {
        ...
        window.diaBridge.onDataChanged('asset_runtime_inspector.inspector_connection_state', function(data) {
            if (data.connected) {
