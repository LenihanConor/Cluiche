...
namespace Dia
{
	...
	{
		// Handles load/save of .diaentity, .diacamera, .dialight blueprint files.
		// File format is owned by DiaEntity / DiaCamera2D / DiaLighting2D; this class
		...
		public:
			...
			// (e.g. ".diaentity" -> "entity_blueprint").
