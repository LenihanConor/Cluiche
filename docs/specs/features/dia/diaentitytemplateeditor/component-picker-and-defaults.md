...
**Status:** Done
**Plan:** @docs/specs/features/dia/DiaEntityTemplateEditor/component-picker-and-defaults.plan.md
...
- `SchemaReader` (in `DiaEntityTemplateEditor`) exposes `GetDefaultValues(typeId)` returning the parsed `default_values` object
