...
## Builds On
@docs/specs/features/dia/diaapplicationfloweditor/real-time-validation.md

## Mockup
@docs/specs/features/dia/diaapplicationfloweditor/mockups/validation-fix-suggestions.html
...
| System | @docs/specs/systems/dia/diaapplicationfloweditor.md | ED-007, ED-013 |
| Feature (upstream) | @docs/specs/features/dia/diaapplicationfloweditor/real-time-validation.md | AC #5 (location), AC #6 (click-to-navigate) |
