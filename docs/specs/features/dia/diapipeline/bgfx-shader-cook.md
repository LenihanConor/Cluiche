...
**Cross-cutting system:** @docs/specs/systems/dia/render-backend.md (RB-011 — bgfx `shaderc` cook step is a first-class pipeline concern)
...
| System (primary) | DiaPipeline | @docs/specs/systems/dia/diapipeline.md |
