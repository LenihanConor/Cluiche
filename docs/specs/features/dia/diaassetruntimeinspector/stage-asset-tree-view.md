...
[mockups/diaassetruntimeinspector.html](mockups/diaassetruntimeinspector.html) — **Stage / Asset Tree** panel (top-right). Shows expandable Stage nodes with child asset nodes, state dots, global asset section, and asset count per stage. Use as the visual acceptance gate after implementation.
