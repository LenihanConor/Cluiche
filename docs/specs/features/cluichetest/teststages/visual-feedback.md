...
| Sibling | @docs/specs/features/cluichetest/teststages/test-stage-infrastructure.md | Depends on Boot menu (Tasks 4-5) and checkpoint system |
...
`In Progress` — plan at @docs/specs/features/cluichetest/teststages/visual-feedback.plan.md
