...
DiaBuildCLI provides extensible command-line tools for asset pipelines and build automation.
...
- **Content creation tools** - No level editors, asset authoring tools (yet - DiaBuildCLI is first step)
...
| 2 | Scope | Are build tools (DiaBuildCLI) part of Dia or separate application? | Part of Dia - they're engine tooling, depend on DiaCore, and extend the engine's capabilities |
