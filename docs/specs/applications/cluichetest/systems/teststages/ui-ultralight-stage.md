...
| Application | @docs/specs/applications/cluichetest/cluichetest.md | AD-001, AD-003, AD-005 |
...
**Visual mockup:** [@docs/specs/applications/cluichetest/systems/teststages/ui-ultralight-stage.mockup.html](ui-ultralight-stage.mockup.html) — open in a browser for visual acceptance gate reference.
