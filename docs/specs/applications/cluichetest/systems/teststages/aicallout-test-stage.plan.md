...
| 9 | Verify: `dia run cluichetest` → AICalloutTestStage; observe wandering emitters, chasing responders, ring colour transitions; all checkpoints pass | E2E gate | In Progress | sonnet | Build 1 succeeded; awaiting build 2 (TTL fix) |
