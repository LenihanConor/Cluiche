...
**Visual mockup:** [@docs/specs/applications/cluichetest/systems/teststages/geometry2d-stage.mockup.html](geometry2d-stage.mockup.html) — open in a browser for visual acceptance gate reference.
