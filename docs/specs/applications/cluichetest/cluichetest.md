...
|--------|-------------|------|
| ApplicationFlow | PU/Stage/Module topology, streams, Boot+DummyStage, concrete modules (Kernel, TimeServer, Render, etc.) | @docs/specs/applications/cluichetest/systems/applicationflow/applicationflow.md |
| Asset Pipeline | End-to-end asset integration: directory structure, pipeline deploy, AssetServiceModule, manifest path aliases | @docs/specs/applications/cluichetest/systems/asset-pipeline/asset-pipeline.md |
| Async Asset Loading | JobSystem-driven two-phase texture load; canonical stage-driven async pattern; DummyStage as reference consumer | @docs/specs/applications/cluichetest/systems/async-asset-loading/async-asset-loading.md |
| CluicheTestScenarios | DiaTestHarness e2e scenario files and test plan for CluicheTest | @docs/specs/applications/cluichetest/systems/cluichetestscenarios/cluichetestscenarios.md |
