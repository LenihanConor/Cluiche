...
|---------|-------------|------|--------|
| Plugin Browser Scaling | Project-scope filter + compact master-detail layout + search + filter chips + palette commands | [plugin-browser-scaling.md](plugin-browser-scaling.md) | Approved |
