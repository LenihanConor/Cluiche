...
|--------|-------------|------|
| CluicheEditor ApplicationFlow | Thin application host layer wiring DiaEditor library classes into DiaApplicationFlow v2 (Module subclasses, manifest, bootstrap) | [applicationflow.md](systems/applicationflow/applicationflow.md) |
...
|---------|-------------|------|--------|
| Plugin Theme System | Shared Pico CSS classless theme with `dia://` scheme delivery and CEF-layer injection for all plugins | [plugin-theme-system.md](systems/plugin-theme/plugin-theme-system.md) | Approved |
