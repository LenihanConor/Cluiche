...
| GoogleTestSpeed | Tooling, build config, and test conventions to drive suite from ~5 min → <90 s | [googletestspeed.md](systems/googletestspeed/googletestspeed.md) |
