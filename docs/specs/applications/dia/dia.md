...
| DiaLighting3D | 3D light library — PointLight3D, DirectionalLight3D, SpotLight3D, AmbientLight3D types, LightRegistry3D, ILightBehaviour3D interface with factory, 3 engine behaviours (Flicker, Pulse, ColorCycle) | [dialighting3d.md](systems/dialighting3d/dialighting3d.md) |
