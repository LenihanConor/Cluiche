...
|---------|-------------|------|--------|
| Manifest Load/Save | Open .diaapp files, parse, save changes with .bak backup | @docs/specs/applications/dia/systems/diaapplicationeditor/manifest-load-save.md | Approved |
| Flow View | State machine diagram showing phases and transitions (react-flow) | @docs/specs/applications/dia/systems/diaapplicationeditor/flow-view.md | Approved |
| Tree View | Hierarchical tree for adding PUs, phases, modules (react-arborist) | @docs/specs/applications/dia/systems/diaapplicationeditor/tree-view.md | Approved |
| View Toggle | Switch between Flow and Tree views with shared state (Zustand) | @docs/specs/applications/dia/systems/diaapplicationeditor/view-toggle.md | Approved |
| Phase Transition Editor | Add/remove transitions by dragging in Flow View | @docs/specs/applications/dia/systems/diaapplicationeditor/phase-transition-editor.md | Approved |
| Module Config Editor | Hybrid form + CodeMirror 6 JSON editing with debounced save (500ms) | @docs/specs/applications/dia/systems/diaapplicationeditor/module-config-editor.md | Approved |
| Type Discovery | Hybrid: query game registry + static fallback for available types | @docs/specs/applications/dia/systems/diaapplicationeditor/type-discovery.md | Approved |
| Real-time Validation | Debounced 500ms validation with inline annotations + error panel | @docs/specs/applications/dia/systems/diaapplicationeditor/real-time-validation.md | Approved |
| File Conflict Detection | Filesystem watcher + non-modal banner for external changes | @docs/specs/applications/dia/systems/diaapplicationeditor/file-conflict-detection.md | Approved |
| Undo/Redo | Ctrl+Z/Y with 8-entry snapshot history, resets on view switch | @docs/specs/applications/dia/systems/diaapplicationeditor/undo-redo.md | Approved |
| PU/Phase Inspector | Reuses inspector panel for PU and Phase property editing (frequency, initial_phase, etc.) | @docs/specs/applications/dia/systems/diaapplicationeditor/pu-phase-inspector.md | Approved |
| Editable Lifecycle Grid | Click cells to toggle module↔phase associations; instant apply | @docs/specs/applications/dia/systems/diaapplicationeditor/editable-lifecycle-grid.md | Approved |
| Import Management | Visualize, edit inline, add/remove manifest imports with provenance badges | @docs/specs/applications/dia/systems/diaapplicationeditor/import-management.md | Approved |
| Validation Navigation | Click validation error → select and scroll to offending node | @docs/specs/applications/dia/systems/diaapplicationeditor/validation-navigation.md | Approved |
| New Manifest | Ctrl+N creates blank manifest (1 PU, 1 Phase); Save triggers Save As | @docs/specs/applications/dia/systems/diaapplicationeditor/new-manifest.md | Approved |

### Live Debugging Features
| Feature | Description | Spec | Status |
|---------|-------------|------|--------|
| WebSocket Connection | Auto-connect to DiaDebugServer via shared GameConnectionManager | @docs/specs/applications/dia/systems/diaapplicationeditor/websocket-connection.md | Approved |
| Live Phase Visualization | Animate phase + edge transitions in Flow View with history | @docs/specs/applications/dia/systems/diaapplicationeditor/live-phase-visualization.md | Approved |
| Runtime State Inspector | Dual pane (Flow + Inspector panel) showing live game state | @docs/specs/applications/dia/systems/diaapplicationeditor/runtime-state-inspector.md | Approved |
| Hot Reload Trigger | No confirmation, immediate reload command to game | @docs/specs/applications/dia/systems/diaapplicationeditor/hot-reload-trigger.md | Approved |
| Runtime Config Push | Config values only (debounced 500ms), structural changes need reload | @docs/specs/applications/dia/systems/diaapplicationeditor/runtime-config-push.md | Approved |
| Risky Change Warnings | Warning on hot reload only, show change summary | @docs/specs/applications/dia/systems/diaapplicationeditor/risky-change-warnings.md | Approved |
...
`Superseded` — Superseded by diaapplicationeditor-v2.md (2026-05-08). Redesigned for PU/Stage/Module v2 model.

**Plan:** @docs/specs/applications/dia/systems/diaapplicationeditor/diaapplicationeditor.plan.md
