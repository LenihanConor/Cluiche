...
## Parent System
@docs/specs/applications/dia/systems/diaenv/diaenv.md

**Cross-cutting system:** @docs/specs/applications/dia/systems/render-backend/render-backend.md (the consumer of this work)
...
This feature is the gating prerequisite for every other Phase 1 feature in the [render-backend system](../render-backend/render-backend.md): no engineer can build `DiaBgfx.vcxproj` until `External/bgfx/` exists with the expected library and header layout.
...
| System | DiaEnv | @docs/specs/applications/dia/systems/diaenv/diaenv.md |
| Cross-cutting system | RenderBackend | @docs/specs/applications/dia/systems/render-backend/render-backend.md |
