...
|---------|-------------|------|--------|
| WebSocket Server | Accept connections, broadcast/send messages, manage clients | [websocket-server.md](websocket-server.md) | Done |
| WebSocket Client | Connect to server, send/receive messages, reconnect logic | [websocket-client.md](websocket-client.md) | Done |
| Threading Model | Worker thread + message queues → main thread callbacks | [threading-model.md](threading-model.md) | Done |
| Text Message Support | UTF-8 text messages (JSON, XML, plain text) with null termination | [text-message-support.md](text-message-support.md) | Done |
| Binary Message Support | Raw byte messages for structs, compressed data, images | [binary-message-support.md](binary-message-support.md) | Done |
| Connection Management | Track active connections, close connections, limits | [connection-management.md](connection-management.md) | Done |
| Error Handling | Structured error codes, severity levels, unified error format | [error-handling.md](error-handling.md) | Done |
