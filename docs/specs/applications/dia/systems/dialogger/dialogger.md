...
> **SUPERSEDED** — 2026-05-18. DiaLogger has been folded into [DiaObservation](../diaobservation/diaobservation.md) as the `Log/` subsystem. Include path: `<DiaObservation/Log/DiaLog.h>`. Namespace: `Dia::Observation::Log::`. This document is historical reference only.
...
|---------|-------------|------|--------|
| Core Logger | Singleton, DIA_LOG macro, LogEntry, LogLevel, thread-local ring buffers, RegisterThreadBuffer/UnregisterThreadBuffer, FlushBuffers | [core-logger.md](core-logger.md) | Done |
| Sink System | ISink interface with level threshold and channel filtering, DebugOutputSink built-in sink | [sink-system.md](sink-system.md) | Done |
