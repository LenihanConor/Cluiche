...
## Parent System
@docs/specs/applications/dia/systems/diagraphics3d/diagraphics3d.md

**Cross-cutting system:** @docs/specs/applications/dia/systems/render-backend/render-backend.md (Phase 2 — specced now, implemented later per RB-003)

**Hard dependencies (already specced, implemented separately):**
- @docs/specs/applications/dia/systems/diamaths/diamaths.md — provides `Vector3D::Cross`, `Matrix44`, `Matrix34`, `Quaternion`, `Transform3D` (all under `Dia::Maths::`)
- @docs/specs/applications/dia/systems/diageometry3d/diageometry3d.md — provides `Dia::Geometry3D::Frustum`, `AABB`, etc.
...
| System (primary) | DiaGraphics3D | @docs/specs/applications/dia/systems/diagraphics3d/diagraphics3d.md |
| System (cross-cutting) | RenderBackend | @docs/specs/applications/dia/systems/render-backend/render-backend.md |
| System (consumed) | DiaMaths | @docs/specs/applications/dia/systems/diamaths/diamaths.md |
| System (consumed, transitively) | DiaGeometry3D | @docs/specs/applications/dia/systems/diageometry3d/diageometry3d.md |
