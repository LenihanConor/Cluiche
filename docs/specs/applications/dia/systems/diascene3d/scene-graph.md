...
**Hard dependencies:**
- @docs/specs/applications/dia/systems/diamaths/diamaths.md — `Transform3D`, `Matrix44`
- @docs/specs/applications/dia/systems/diageometry3d/diageometry3d.md — `Frustum`, `AABB`, `IntersectionTests::Test(AABB, Frustum)`
