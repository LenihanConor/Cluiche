...
| System | @docs/specs/applications/dia/systems/diasoftbody2d/diasoftbody2d.md | **visual-debugger** |

**Status:** `Deferred` — moved to separate spec: [DiaSoftBody2DVisualDebugger](../diarigidbody2dvisualdebugger/diarigidbody2dvisualdebugger.md)
