...
**Spec:** @docs/specs/applications/dia/systems/diaapplication/diaapplication.md  
**Status:** Not Started  
**Started:** 2026-05-06  
...
| Feature | Spec |
|---------|------|
| A — Manifest Imports | @docs/specs/applications/dia/systems/diaapplication/manifest-imports.md |
| B — PU Parent-Child Tree | @docs/specs/applications/dia/systems/diaapplication/pu-parent-child-tree.md |
| C — Stage Manifests | @docs/specs/applications/dia/systems/diaapplication/stage-manifests.md |
