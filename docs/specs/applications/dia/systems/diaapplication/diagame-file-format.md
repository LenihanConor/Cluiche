...
| System | DiaApplicationFlow | @docs/specs/applications/dia/systems/diaapplication/diaapplication.md |
| Feature | **DiaGame File Format and Typed Imports** | (this document) |

**Status:** `Done`

**Depends on:** @docs/specs/applications/dia/systems/diaapplication/manifest-imports.md (Phase A — import resolution)
**Supersedes (partial):** The import format in @docs/specs/applications/dia/systems/diaapplication/stage-manifests.md — flat string imports replaced by typed import objects; `.diastage` wrapper introduced.
