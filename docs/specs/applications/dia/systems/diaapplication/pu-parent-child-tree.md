...
**Plan:** @docs/specs/applications/dia/systems/diaapplication/pu-parent-child-tree.plan.md
**Research:** @docs/research/diappl_flow_tree/summary.md (Phase B)
**Depends on:** @docs/specs/applications/dia/systems/diaapplication/manifest-imports.md (Phase A — merged manifests provide the PU entries that build the tree)
