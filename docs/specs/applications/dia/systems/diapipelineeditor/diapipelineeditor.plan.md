...
**Spec:** @docs/specs/applications/dia/systems/diapipelineeditor/diapipelineeditor.md  
**Status:** In Progress  
**Started:** 2026-04-27  
...
|---|---------|------|------|--------|
| 1 | ndjson-tailer | @docs/specs/applications/dia/systems/diapipelineeditor/ndjson-tailer.md | @docs/specs/applications/dia/systems/diapipelineeditor/ndjson-tailer.plan.md | Done |
| 2 | pipeline-panel-ui | @docs/specs/applications/dia/systems/diapipelineeditor/pipeline-panel-ui.md | @docs/specs/applications/dia/systems/diapipelineeditor/pipeline-panel-ui.plan.md | Done |
| 3 | build-trigger | @docs/specs/applications/dia/systems/diapipelineeditor/build-trigger.md | @docs/specs/applications/dia/systems/diapipelineeditor/build-trigger.plan.md | Done |
| 4 | run-history | @docs/specs/applications/dia/systems/diapipelineeditor/run-history.md | @docs/specs/applications/dia/systems/diapipelineeditor/run-history.plan.md | Done |
| 5 | sub-step-visibility | @docs/specs/applications/dia/systems/diapipelineeditor/sub-step-visibility.md | — | Done |
| 6 | pipeline-build-ux | @docs/specs/applications/dia/systems/diapipelineeditor/pipeline-build-ux.md | @docs/specs/applications/dia/systems/diapipelineeditor/pipeline-build-ux.plan.md | In Progress |
