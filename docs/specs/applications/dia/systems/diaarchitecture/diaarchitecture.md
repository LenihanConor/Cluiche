...
|---|---------|------|--------|------|
| C7 | Layer formalisation — assign `layer:` to all modules + refactoring actions | [layer-formalisation.md](layer-formalisation.md) | Approved | M |
| C1 | Architecture audit tool — `dia check --tool=arch` | [arch-audit-tool.md](arch-audit-tool.md) | Approved | S |
