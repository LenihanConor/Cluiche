...
- F1 — @docs/specs/applications/dia/systems/diaapplicationflow/stream-topology-manifest.md
- F3 — @docs/specs/applications/dia/systems/diaapplicationflow/stream-policy-envelope.md
- F2 — @docs/specs/applications/dia/systems/diaapplicationflow/lifecycle-events.md
- F4 — @docs/specs/applications/dia/systems/diaapplicationflow/stream-tap.md

**Parent system:** @docs/specs/applications/dia/systems/diaapplicationflow/diaapplicationflow.md
