...
This plugin is the **runtime counterpart** to [DiaApplicationFlowEditor](../diaapplicationfloweditor/diaapplicationfloweditor.md) (the asset editor). The Editor handles static `.diaapp` file editing; the Inspector handles live game state observation and control.
