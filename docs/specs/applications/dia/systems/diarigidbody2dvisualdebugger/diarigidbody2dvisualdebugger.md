...
`Superseded` — superseded by [diavisualdebugger.md](../diavisualdebugger/diavisualdebugger.md) (`rigidbody2d-visual-debugger-stack` feature). Decisions SD-VD-001 through SD-VD-004 are folded into DiaVisualDebugger.
