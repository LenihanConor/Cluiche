...
|---------|-------------|------|--------|
| command-registry | Core command registration and discovery system | [command-registry.md](command-registry.md) | Done |
| cli-parser | Argument parsing (positional, named, flags) | [cli-parser.md](cli-parser.md) | Done |
| help-system | Auto-generated help text from registered commands | [help-system.md](help-system.md) | Done |
| event-system | Lifecycle events for command execution | [event-system.md](event-system.md) | Done |
| python-bindings | Automatic Python exposure of all registered commands via DiaPython | [python-bindings.md](python-bindings.md) | Done |
