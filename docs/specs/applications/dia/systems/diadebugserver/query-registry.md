...
## Parent System
@docs/specs/applications/dia/systems/diadebugserver/diadebugserver.md
...
| Application | @docs/specs/applications/dia/dia.md | AD-001 (module system), AD-002 (no STL public APIs), AD-003 (namespace Dia::\<Module\>::) |
| System | @docs/specs/applications/dia/systems/diadebugserver/diadebugserver.md | DDS-001 (generic system), DDS-005 (JSON over WebSocket), DDS-008 (forward commands to DiaAPI), DDS-010 (JSON serialization) |
...
**Plan:** @docs/specs/applications/dia/systems/diadebugserver/query-registry.plan.md
