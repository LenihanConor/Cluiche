...
**Note:** WebSocket functionality is provided by DiaWebSocket::Server (see @docs/specs/applications/dia/systems/diawebsocket/diawebsocket.md)
...
Message types, wire format, serialization helpers, and data type constants are defined in the shared **DiaDebugProtocol** system (@docs/specs/applications/dia/systems/diadebugprotocol/diadebugprotocol.md). DiaDebugServer uses these types directly for all message construction and parsing.
...
- **DiaDebugProtocol** - Shared message types, serialization helpers, and data type constants (header-only, @docs/specs/applications/dia/systems/diadebugprotocol/diadebugprotocol.md)
...
|---------|-------------|------|--------|
| WebSocket Server Management | Start/stop server, handle connections, thread management | @docs/specs/applications/dia/systems/diadebugserver/websocket-server-management.md | Approved |
| Core Metrics Broadcasting | Broadcast FPS, memory, frame time every 500ms | @docs/specs/applications/dia/systems/diadebugserver/core-metrics-broadcasting.md | Approved |
| Subscription Management | Handle subscribe/unsubscribe requests, track subscriptions per connection | @docs/specs/applications/dia/systems/diadebugserver/subscription-management.md | Approved |
| State Serialization | Serialize ProcessingUnit/Phase/Module state to JSON | @docs/specs/applications/dia/systems/diadebugserver/state-serialization.md | Approved |
| Event Broadcasting | Forward MessageBus events to subscribed editors | @docs/specs/applications/dia/systems/diadebugserver/event-broadcasting.md | Approved |
| DiaAPI Command Gateway | Receive commands via WebSocket, forward to CommandRegistry, return results | @docs/specs/applications/dia/systems/diadebugserver/diaapi-command-gateway.md | Approved |
| Protocol Command Handling | Handle subscribe, unsubscribe, get_state commands | @docs/specs/applications/dia/systems/diadebugserver/protocol-command-handling.md | Approved |
| Query Registry | Structured remote query dispatch — domain modules register JSON-in/JSON-out handlers; migrates protocol commands | @docs/specs/applications/dia/systems/diadebugserver/query-registry.md | Approved |
| Server Self-Monitoring | Track game/editor performance impact, server health metrics, debugging | @docs/specs/applications/dia/systems/diadebugserver/server-self-monitoring.md | Approved |
| Connection Health | Per-topic stats, subscription-gated ObservationBridge, subscribe ACK, tiered drop warnings in editor UI | @docs/specs/applications/dia/systems/diadebugserver/connection-health.md | Approved |
