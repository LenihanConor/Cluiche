...
## Parent System
@docs/specs/applications/dia/systems/diagraphics/diagraphics.md

**Cross-cutting system:** @docs/specs/applications/dia/systems/render-backend/render-backend.md (RB-007, RB-009 — gates DiaBgfx work and the async-loader integration)

**Coordinates with:** @docs/specs/applications/cluichetest/systems/async-asset-loading/async-asset-loading.md (Approved 2026-05-17 — that system's TextureHandler-Two-Phase-Load feature must be re-planned against the new ITexture API; details in this spec's *Coordination* section)
...
This is the *first* implementation feature in the [render-backend system](../render-backend/render-backend.md) Phase 1 (per RB-009): it must land before any DiaBgfx code, because `DiaBgfx::TextureHandle` is a second `ITexture` implementer and the SpriteDrawCommand path consumes `ITexture*` regardless of backend.
...
| System (primary) | DiaGraphics | @docs/specs/applications/dia/systems/diagraphics/diagraphics.md |
| System (cross-cutting) | RenderBackend | @docs/specs/applications/dia/systems/render-backend/render-backend.md |
| System (coordinated) | Async Stage Asset Loading | @docs/specs/applications/cluichetest/systems/async-asset-loading/async-asset-loading.md |
