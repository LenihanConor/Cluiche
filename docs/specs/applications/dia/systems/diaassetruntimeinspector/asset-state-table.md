...
| System | DiaAssetRuntimeInspector | @docs/specs/applications/dia/systems/diaassetruntimeinspector/diaassetruntimeinspector.md |
...
A single dockable CEF panel named "Asset State Table" rendered within the DiaAssetRuntimeInspector plugin area. Contains:
...
| File | Action |
|------|--------|
| `Dia/DiaAssetRuntimeInspector/Panels/AssetStateTablePanel.h` | Create |
| `Dia/DiaAssetRuntimeInspector/Panels/AssetStateTablePanel.cpp` | Create |
| `Dia/DiaAssetRuntimeInspector/Panels/AssetStateRow.h` | Create |
| `Dia/DiaAssetRuntimeInspector/UI/asset-state-table.html` | Create |
| `Dia/DiaAssetRuntimeInspector/UI/asset-state-table.js` | Create |
| `Dia/DiaAssetRuntimeInspector/UI/asset-state-table.css` | Create |
| `Cluiche/Tests/UnitTests/DiaAssetRuntimeInspector/AssetStateTableTests.cpp` | Create |
...
| PD-009 | Generated output under Cluiche/out/ | Compliant -- session context written to `Cluiche/out/CluicheEditor/DiaAssetRuntimeInspector/` |
| AD-001 | Module system with YAML frontmatter | Compliant -- module doc will be created with DiaAssetRuntimeInspector system |
| AD-003 | Namespace Dia::\<Module\>:: | Compliant -- all code under `Dia::AssetRuntime::Inspector::` |
...
| SD-ARED-004 | Output to Cluiche/out/CluicheEditor/DiaAssetRuntimeInspector/ | Compliant -- session context path follows this rule |
...
mockups/diaassetruntimeinspector.html — **Asset State Table** panel (top-left). Shows filterable table with state/scope/ref count columns, color-coded state badges, and row selection. Use as the visual acceptance gate after implementation.
