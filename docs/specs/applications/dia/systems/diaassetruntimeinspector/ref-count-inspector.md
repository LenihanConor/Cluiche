...
A dockable CEF panel named "Ref Count Inspector" rendered within the DiaAssetRuntimeInspector plugin area. Contains:
...
| File | Action |
|------|--------|
| `Dia/DiaAssetRuntimeInspector/Panels/RefCountInspectorPanel.h` | Create |
| `Dia/DiaAssetRuntimeInspector/Panels/RefCountInspectorPanel.cpp` | Create |
| `Dia/DiaAssetRuntimeInspector/UI/ref-count-inspector.html` | Create |
| `Dia/DiaAssetRuntimeInspector/UI/ref-count-inspector.js` | Create |
| `Dia/DiaAssetRuntimeInspector/UI/ref-count-inspector.css` | Create |
| `Cluiche/Tests/UnitTests/DiaAssetRuntimeInspector/RefCountInspectorTests.cpp` | Create |
...
mockups/diaassetruntimeinspector.html — **Ref Count Inspector** panel (bottom-left). Shows selected global asset with ref count, scope, deploy path, and per-Stage reference breakdown. Use as the visual acceptance gate after implementation.
