...
|---------|-------------|------|--------|
| interpreter-lifecycle | Python interpreter initialization, shutdown, state management | [interpreter-lifecycle.md](interpreter-lifecycle.md) | Done |
| script-execution | Execute .py files and Python code strings (synchronous only) | [script-execution.md](script-execution.md) | Done |
| module-api | Clean C++ API for creating Python modules (wraps pybind11) | [module-api.md](module-api.md) | Done |
| type-conversion | C++ ↔ Python type conversion utilities | [type-conversion.md](type-conversion.md) | Done |
| error-handling | Python exception handling and propagation | [error-handling.md](error-handling.md) | Done |
