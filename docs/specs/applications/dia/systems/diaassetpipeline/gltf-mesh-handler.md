...
**Parent:** @docs/specs/applications/dia/systems/diaassetpipeline/diaassetpipeline.md
...
`Done` — Plan: @docs/specs/applications/dia/systems/diaassetpipeline/gltf-mesh-handler.plan.md
