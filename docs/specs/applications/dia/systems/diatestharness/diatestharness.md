...
|---------|-------------|------|--------|
| Harness Core | WebSocket client, app launcher, scenario runner, observation framework, test plan orchestrator, DiaCLI shim, result output | [harness-core.md](harness-core.md) | Approved |
| Smoke Test Scenario | Moved to CluicheTest/CluicheTestScenarios — app owns its scenarios | @docs/specs/applications/cluichetest/systems/cluichetestscenarios/smoke-test-scenario.md | Approved |
