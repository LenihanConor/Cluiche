...
|---------|-------------|------|--------|
| graphics-3d-types | `Camera3D`, lights, `Mesh3DDrawCommand`, `Mesh3DFrameData`, `FrameData3D`; new `Dia/DiaGraphics3D/` module; no maths primitives defined here | [graphics-3d-types.md](../../features/dia/diagraphics3d/graphics-3d-types.md) | Approved |
