...
|---------|-------------|------|--------|
| Module and Build | DiaAutomation vcxproj, namespace, module doc, project references | [module-and-build.md](../../features/dia/diaautomation/module-and-build.md) | Approved |
| Checkpoint Registry | Register/unregister/run checkpoints, module-scoped lifetime, `dia.automation.validate` command | [checkpoint-registry.md](../../features/dia/diaautomation/checkpoint-registry.md) | Approved |
...
`Done` (2026-05-21) — All feature specs Approved; implementation complete. Plan: [diaautomation.plan.md](../../features/dia/diaautomation/diaautomation.plan.md)
