...
| 6 | React+Vite Migration | M | Replace multi-iframe plain HTML/JS UI with a single React+Vite app consuming `@dia/editor-ui`. 4 panels become tab components. No behaviour changes. | [asset-runtime-inspector-react-migration.md](../../features/dia/diaassetruntimeinspector/asset-runtime-inspector-react-migration.md) | Done |
