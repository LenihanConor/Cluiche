...
| Editor Memory | Invisible save/restore of layout, loaded plugins, and per-plugin project-scoped state on editor close/open | @docs/specs/features/dia/diaeditor/editor-memory.md | Approved |
