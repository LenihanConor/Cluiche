**Spec:** @docs/specs/systems/googletests/googletestspeed.md
**Status:** In Progress
...
| 5 | fixture-amortisation: `SetUpTestSuite`/`TearDownTestSuite` in 5 Python test files | `dia run googletest --filter="DiaPython*"` passes | Pending | haiku | C++ edit only; `TestLifecycle.cpp` must NOT be changed |
