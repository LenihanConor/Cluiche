...
**[→ DiaApplication API](../05-api/dia/application-api.md)**
...
**[→ Transform Performance Notes](../07-subsystems/dia-maths/performance-notes.md)**
...
**[→ DiaSFML API](../05-api/dia/sfml-api.md)**
