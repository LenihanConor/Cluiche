...
- **[→ Performance Testing](../04-testing/performance-testing.md)** - Performance test strategy
...
**[→ Container Performance Notes](../07-subsystems/dia-core/containers.md)**
...
**[→ Test Coverage Targets](../04-testing/test-coverage-targets.md)**
...
**[→ API Documentation](../05-api/api-overview.md)**
...
**[→ Coding Standards](../09-development/coding-standards.md)**
...
**[→ Building the Project](../00-getting-started/building-the-project.md)**
