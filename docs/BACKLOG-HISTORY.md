...
| DiaThreading | [diathreading.md](specs/systems/dia/diathreading.md) | 2026-05-20 | 2 features Done: JobSystem/JobHandle extracted from DiaCore into new DiaThreading static lib (`Dia::Threading::` namespace); ThreadPool metric counters added; `dia.jobs.*` metrics (queue_depth, submitted, completed, active_workers) registered in JobSystemModule via DiaObservation. Breaks DiaCore→DiaObservation cycle. 4818 tests pass. |
