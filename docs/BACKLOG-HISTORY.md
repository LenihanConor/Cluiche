...
| component-readonly-flag | [component-readonly-flag.md](specs/features/dia/diaentity/component-readonly-flag.md) | DiaEntity | 2026-06-01 — `DIA_READONLY` + `DIA_WRITES(Target)` macros, Domain enforcement (skip hooks for readonly, single-writer assert on add/remove). Enshrines SD-ENT-022. 17 GoogleTests pass. |
