...
| Shared asset creation | [Spec](specs/features/dia/diaassetcatalogueeditor/shared-asset-creation.md) Approved + [Plan](specs/features/dia/diaassetcatalogueeditor/shared-asset-creation.plan.md) ready. Unifies `create_scene`/`create_from_template` behind `asset_catalogue.create_asset`. Includes: stage dropdown grey styling, stage↔scene association write-back, Blueprint Editor "+New Template" button. |
