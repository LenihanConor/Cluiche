...
See [Module Metadata Schema](../10-reference/module-metadata-schema.md) for details.
...
- See [Thread Safety Guide](../06-ai-guides/thread-safety-guide.md)
...
### For Humans:
- **[Architecture Overview](../01-architecture/architecture.md)** - Understand the full system
- **[Design Philosophy](../02-design/design.md)** - Understand why decisions were made
...
- [API Documentation](../05-api/api-overview.md) - Public interface reference
- [Module Registry](../10-reference/module-registry.md) - All 56 modules cataloged
