...
**[→ API Documentation](../05-api/dia/application-api.md)**  
**[→ Subsystem Deep Dive](../07-subsystems/dia-application/overview.md)**
...
**[→ API Documentation](../05-api/dia/core-api.md)**  
**[→ Subsystem Deep Dive](../07-subsystems/dia-core/overview.md)**
...
**[→ API Documentation](../05-api/dia/graphics-api.md)**  
**[→ Subsystem Deep Dive](../07-subsystems/dia-graphics/overview.md)**
...
**[→ API Documentation](../05-api/dia/maths-api.md)**  
...
**[→ API Documentation](../05-api/dia/input-api.md)**
...
**[→ API Documentation](../05-api/dia/ui-api.md)**
...
**[→ API Documentation](../05-api/dia/window-api.md)**
...
**[→ API Documentation](../05-api/dia/sfml-api.md)**
...
**[→ External documentation links](../10-reference/external-links.md)**
...
**[→ Design patterns details](../02-design/design-patterns.md)**
...
**Complete Registry:** [Module Registry](../10-reference/module-registry.md) lists all 56 modules

**Schema Documentation:** [Module Metadata Schema](../10-reference/module-metadata-schema.md)
...
**[→ Complete file locations](../10-reference/file-locations.md)**
...
**[→ Visual Studio guide](../09-development/visual-studio-guide.md)**
...
- [Design Philosophy](../02-design/design.md) - Why things are the way they are
- [Why Dia Engine?](../02-design/why-dia.md) - Engine design decisions
- [Why Module/Phase/PU?](../02-design/why-module-phase-pu.md) - Threading rationale

### API Documentation

- [API Overview](../05-api/api-overview.md) - Public interface reference
- [DiaApplication API](../05-api/dia/application-api.md) - Framework API
- [DiaCore API](../05-api/dia/core-api.md) - Core utilities API

### For AI Agents

- [AI-README](../06-ai-guides/AI-README.md) - AI-optimized entry point
- [Codebase Map](../06-ai-guides/codebase-map.md) - Structured navigation
- [Entry Points](../06-ai-guides/entry-points.md) - Task-based starting points
