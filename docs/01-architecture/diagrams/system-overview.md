...
This diagram shows the three-layer architecture of the Cluiche game engine:

- **Cluiche Application Layer** (blue) - The main application with processing units and levels
- **Dia Engine Layer** (purple) - The platform layer with core subsystems
- **External Dependencies** (green) - Third-party libraries
