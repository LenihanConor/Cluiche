...
**[→ Module Registry](../10-reference/module-registry.md)** - Complete catalog
...
**[→ Containers deep dive](../07-subsystems/dia-core/containers.md)**
...
**[→ Type system deep dive](../07-subsystems/dia-core/type-system.md)**
...
**[→ DiaCore API Documentation](../05-api/dia/core-api.md)**
...
**[→ DiaMaths API Documentation](../05-api/dia/maths-api.md)**
...
**[→ DiaGraphics API Documentation](../05-api/dia/graphics-api.md)**
...
**[→ DiaInput API Documentation](../05-api/dia/input-api.md)**
...
**[→ DiaUI API Documentation](../05-api/dia/ui-api.md)**
...
**[→ DiaSFML API Documentation](../05-api/dia/sfml-api.md)**
...
**[→ Complete dependency graph](../06-ai-guides/dependency-graph.md)**
...
**[→ Complete Module Registry](../10-reference/module-registry.md)**  
**[→ Module Metadata Schema](../10-reference/module-metadata-schema.md)**
