...
### Design
- [Why Module/Phase/PU?](../02-design/why-module-phase-pu.md) - Design rationale
- [Design Patterns](../02-design/design-patterns.md) - Common patterns

### API Documentation
- [DiaApplication API](../05-api/dia/application-api.md) - Module/Phase/PU API reference
- [Module Lifecycle](../07-subsystems/dia-application/module-lifecycle.md) - Detailed lifecycle
