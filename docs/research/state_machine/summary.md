...
- DiaApplication's Phase system is a bespoke state machine — powerful but not reusable. The generic FSM should integrate with it (operate within phases/modules), not replace it.
