...
**Complete Module Registry:** See [module-registry.md](../10-reference/module-registry.md) for all 56 modules.
...
5. **Add to Visual Studio project** → See [visual-studio-guide.md](../09-development/visual-studio-guide.md)
...
3. **Check known issues** → [known-issues.md](../09-development/known-issues.md)
   - Transform2D multiple traversals
   - Random number generation (recently fixed)
4. **Add thread safety test** → See [thread-safety-testing.md](../04-testing/thread-safety-testing.md)

### Task: Fix a Bug in DiaMaths

1. **Read known issues** → [known-issues.md](../07-subsystems/dia-maths/known-issues.md)
...
5. **Update documentation** → Add to [changelog.md](../09-development/changelog.md)
...
**Detailed Issues:** See [known-issues.md](../09-development/known-issues.md)
...
- [Design philosophy](../02-design/design.md)
...
- [Module registry](../10-reference/module-registry.md) - All 56 modules
...
4. **Parse module files** → See [module-registry.md](../10-reference/module-registry.md)
