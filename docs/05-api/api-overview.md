...
**[→ Full Module Pattern](../06-ai-guides/patterns-reference.md#pattern-1-module)**
...
**[→ Container Patterns](../06-ai-guides/patterns-reference.md#pattern-11-dynamicarray)**
...
**[→ Threading Patterns](../06-ai-guides/thread-safety-guide.md#pattern-1-producer-consumer-framestream)**
...
**[→ External Dependencies](../01-architecture/external-dependencies.md)**
...
- **Code Patterns:** [Patterns Reference](../06-ai-guides/patterns-reference.md)
- **Entry Points:** [Common Tasks](../06-ai-guides/entry-points.md)
